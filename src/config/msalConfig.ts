...
export const msalConfig: Configuration = {
    ...
    redirectUri: import.meta.env.VITE_APP_LOCAL_WEB_URL || window.location.origin,
    postLogoutRedirectUri: import.meta.env.VITE_APP_LOCAL_WEB_URL || window.location.origin,
  },
    cache: {
